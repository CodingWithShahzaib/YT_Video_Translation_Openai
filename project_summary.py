...
def display_project_info():
    ...
    print("2. Analyze original video duration (FFmpeg)")
    print("3. Extract audio from video (FFmpeg)")
    print("4. Transcribe English audio (OpenAI Whisper)")
    print("5. Translate to Hindi (OpenAI GPT-4)")
    print("6. Generate Hindi speech (OpenAI TTS)")
    print("7. Match audio duration to original video (FFmpeg)")
    print("8. Replace original audio with synchronized audio (FFmpeg)")
    print()
    
    print("🎯 Key Features:")
    print("✅ Support for local video files")
    print("✅ YouTube video download and translation")
    print("✅ Audio duration synchronization")
